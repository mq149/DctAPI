...
namespace DctAPI.Models
{
   ...
   .HasData(
       ...
       .HasData(
           new DiaChiEntity
           {
               Id = 1, SoNhaTo = "29", Duong = "Hoàng Diệu", XaPhuong = "Phường 1", QuanHuyen = "Quận 4", TinhTP = "TP Hồ Chí Minh"
           },
           new DiaChiEntity
            {
                Id = 2, SoNhaTo = "69", Duong = "Ba Tháng Hai", XaPhuong = "Phường 10", QuanHuyen = "Quận 10", TinhTP = "TP Hồ Chí Minh"
            },
           new DiaChiEntity
            {
                Id = 3, SoNhaTo = "19", Duong = "Lý Thường Kiệt", XaPhuong = "Phường 3", QuanHuyen = "Quận 10", TinhTP = "TP Hồ Chí Minh"
            },
           new DiaChiEntity
            {
                Id = 4, SoNhaTo = "12",Duong = "K3", XaPhuong = "Vĩnh Sơn", QuanHuyen = "Vĩnh Thạnh", TinhTP = "Bình Định"
            }
       );

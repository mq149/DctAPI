...
namespace DctAPI.Migrations
{
    public partial class initialized : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "HinhAnh",
                columns: new[] { "Id", "Ten", "Url" },
                values: new object[,]
                {
                    { 1, "shorts", "https://i.ibb.co/4ZN1Rqd/shorts.png" },
                    { 2, "trousers", "https://i.ibb.co/JpWst3h/trousers.png" },
                    { 3, "shirt", "https://i.ibb.co/KDm7xG1/shirt.png" },
                    { 4, "tie", "https://i.ibb.co/YpxxV8L/tie.png" },
                    { 5, "sweater", "https://i.ibb.co/hY1ft7r/sweater1.png" },
                    { 6, "shoes", "https://i.ibb.co/djqfkpN/shoes.png" }
                });

            migrationBuilder.InsertData(
                table: "KhoaDaoTao",
                columns: new[] { "Id", "HuongDan", "NoiDung", "URL" },
                values: new object[] { 1, "Vui lòng xem video hướng dẫn để làm bài kiểm tra.", "Khoá đào tạo shipper Đi Chợ Thuê", "https://www.youtube.com/embed/LcRG816Syvc" });
            ...
            migrationBuilder.InsertData(
                table: "SanPham",
                columns: new[] { "Id", "DonHangEntityId", "GiaSP", "HinhSanPhamID", "LoaiSPID", "MoTa", "NSXID", "NgaySanXuat", "Ten" },
                values: new object[,]
                {
                    { 1, null, 120000f, 1, 4, "Rất ngon và rẻ", 1, new DateTime(2015, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cá Thu" },
                    { 2, null, 12000f, 1, 1, "Không ngon đâu", 1, new DateTime(2015, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cà Rốt" },
                    { 3, null, 120000f, 1, 3, "C", 1, new DateTime(2015, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Vitamin C" }
                });

    ...
    public partial class Update : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Cống Quỳnh", "Quận 1", "189C", "TP. HCM", "Nguyễn Cư Trinh" },
                    { 2, "Nguyễn Văn Cừ", "Quận 5", "227", "TP. HCM", "Phường 4" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, null, 2, "shipper@email.com", null, "Bùi Minh Quân", "123456", null, 3, "0123333444" },
                    { 1, null, 1, "cuahangcoop@email.com", null, "Cua Hang Co-op Mart", "123456", null, 2, "0123456789" },
                    { 3, null, 2, "khachhangA@email.com", null, "Khách hàng A", "123456", null, 4, "0123123123" }
                });

            migrationBuilder.InsertData(
                table: "CuaHang",
                columns: new[] { "Id", "LoaiCHId", "TenCuaHang", "TrangThaiKichHoat", "UserId" },
                values: new object[] { 1, null, "Co-op Mart Cống Quỳnh", true, 1 });

            migrationBuilder.InsertData(
                table: "KhachHang",
                columns: new[] { "Id", "CMND", "UserId" },
                values: new object[] { 1, "123444222", 3 });

            migrationBuilder.InsertData(
                table: "Shipper",
                columns: new[] { "Id", "BienSo", "CMND", "DongXe", "KichHoat", "UserId" },
                values: new object[] { 1, "00A0-0000", "000111222", "Honda Wave", true, 2 });

            migrationBuilder.InsertData(
                table: "DonHang",
                columns: new[] { "Id", "CuaHangId", "DiaChiGiaoId", "KhachHangId", "NgayGiao", "NgayMuaHang", "PTTTId", "ShipperId", "TTDHId", "TongTien" },
                values: new object[] { 1, 1, 2, 1, new DateTime(2021, 12, 20, 11, 53, 1, 271, DateTimeKind.Local).AddTicks(552), new DateTime(2021, 12, 20, 11, 53, 1, 272, DateTimeKind.Local).AddTicks(2297), 1, null, 2, 500000f });
